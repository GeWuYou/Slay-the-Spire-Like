...
public partial class CardDraggingState : CardState
{
    ...
    /// </remarks>
    [Export]
    public float DragMinimumThreshold { private set; get; } = 0.05f;
    ...
    {
        // 发送卡牌结束拖拽的事件
        Events.Instance.RaiseCardDraggingEnded(CardUi);
    }
    ...
    public override void OnInput(InputEvent @event)
    {
        ...
        // 处理鼠标移动事件，更新卡牌位置
        if (isMouseMotion) CardUi.GlobalPosition = CardUi.GetGlobalMousePosition() - CardUi.PivotOffset;
